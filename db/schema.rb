...
ActiveRecord::Schema[7.1].define(version: 2023_11_29_184327) do
  ...
  create_table "entities", force: :cascade do |t|
    ...
    t.index ["name_id"], name: "index_entities_on_name_id"
  end
  ...
  add_foreign_key "entities", "users", column: "name_id"
end
